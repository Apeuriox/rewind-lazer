...
class Beatmap {
    ...
    get hitObjectTimes() {
        try {
            ...
            wasm.beatmap_hitObjectTimes(retptr, this.__wbg_ptr);
...
class DifficultyAttributes {
    ...
    get nLargeTicks() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_difficultyattributes_nLargeTicks(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            return r0 === 0 ? undefined : r1 >>> 0;
        } finally {
    ...
    get nHoldNotes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_difficultyattributes_nHoldNotes(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            return r0 === 0 ? undefined : r1 >>> 0;
        } finally {
...
class Performance {
    ...
    set sliderEndHits(slider_end_hits) {
        wasm.performance_set_slider_ends_hit(this.__wbg_ptr, !isLikeNone(slider_end_hits), isLikeNone(slider_end_hits) ? 0 : slider_end_hits);
    }
    /**
     * @param {boolean | undefined} [hardrock_offsets]
     */
    ...
    /**
     * @param {number | undefined} [large_tick_hits]
     */
    set largeTickHits(large_tick_hits) {
        wasm.performance_set_large_ticks_hits(this.__wbg_ptr, !isLikeNone(large_tick_hits), isLikeNone(large_tick_hits) ? 0 : large_tick_hits);
    }
    /**
     * @param {number | undefined} [small_tick_hits]
     */
    set smallTickHits(small_tick_hits) {
        wasm.performance_set_small_ticks_hits(this.__wbg_ptr, !isLikeNone(small_tick_hits), isLikeNone(small_tick_hits) ? 0 : small_tick_hits);
    }
    /**
    ...
    /**
     * @param {number | undefined} [legacy_total_score]
     */
    set legacyTotalScore(legacy_total_score) {
        wasm.performance_set_legacy_total_score(this.__wbg_ptr, !isLikeNone(legacy_total_score), isLikeNone(legacy_total_score) ? 0 : legacy_total_score);
    }
    /**
     * @param {HitResultGenerator | undefined} [hitresult_generator]
     * @param {GameMode | undefined} [mode]
     */
...
class Strains {
    ...
    /**
     * Reading strains for osu! and osu!taiko.
     * @returns {Float64Array | undefined}
     */
    get reading() {
        try {
...
module.exports.__wbg_getwithrefkey_99f5ce32a6c6bb24 = function(arg0, arg1) {
...
module.exports.__wbg_set_aafbfcb4e272c953 = function(arg0, arg1, arg2) {
